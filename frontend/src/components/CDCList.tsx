								...
								.map((course) => {
									...
									return (
										...
										<div
											...
											className={`relative px-4 transition duration-200 ease-in-out cursor-pointer h-14 border-slate-300 dark:border-slate-600 items-center flex justify-between ${clashing
